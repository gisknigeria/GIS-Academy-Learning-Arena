        ...
        <div className="auth-panel__inner">
          ...
          <form className="auth-form" onSubmit={(e) => void handleSubmit(e)}>
            ...
            <div className="auth-role-picker" role="radiogroup" aria-label="Account type">
              <button type="button" role="radio" className={accountType === "STUDENT" ? "selected" : ""} onClick={() => setAccountType("STUDENT")} aria-checked={accountType === "STUDENT"}>
                <span className="auth-role-icon"><GraduationCap size={18} /></span>
                <strong>Learner</strong>
                <span>Start learning immediately</span>
              </button>
              <button type="button" role="radio" className={accountType === "TRAINER" ? "selected" : ""} onClick={() => setAccountType("TRAINER")} aria-checked={accountType === "TRAINER"}>
